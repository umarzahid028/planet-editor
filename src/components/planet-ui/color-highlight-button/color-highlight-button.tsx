...
// --- Planet UI ---
import type { UseColorHighlightConfig } from "@/components/planet-ui/color-highlight-button"
import {
...
// --- Styles ---
import "@/components/planet-ui/color-highlight-button/color-highlight-button.scss"
    ...
    return (
      ...
      >
        {children ?? (
          <>
            <span
              className="planet-button-highlight"
              style={
