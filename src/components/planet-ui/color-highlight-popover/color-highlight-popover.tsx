...
// --- Icons ---
import { BanIcon } from "@/components/planet-icons/ban-icon"
...
} from "@/components/planet-ui/color-highlight-button"
import {
...
>(({ className, children, ...props }, ref) => (
  <Button
    ...
    {...props}
  >
    {children ?? <HighlighterIcon className="planet-button-icon" />}
  </Button>
))
      ...
      <CardBody style={isMobile ? { padding: 0 } : {}}>
        <CardItemGroup orientation="horizontal">
          ...
          <ButtonGroup>
            ...
            >
              <BanIcon className="planet-button-icon" />
            </Button>
          </ButtonGroup>
        </CardItemGroup>
      </CardBody>
