import type { Node as PMNode } from "@/planet-core/pm/model"
import type { Transaction } from "@/planet-core/pm/state"
...
import {
  ...
  Selection,
  TextSelection,
} from "@/planet-core/pm/state"
import { cellAround, CellSelection } from "@/planet-core/pm/tables"
import {
  findParentNodeClosestToPos,
  type Editor,
  type NodeWithPos,
} from "@/planet-core/react"
...
/**
 * Checks if one or more extensions are registered in the Planet editor.
 * @param editor - The Planet editor instance
 ...
 * @param props.editor The Planet editor instance
 ...
 * @param editor Planet editor instance
...
export const handleImageUpload = async (
  ...
  // Demo upload: there's no backend, so simulate progress and then embed the
  // selected file as a base64 data URL. This makes the real image render (and
  // persist in the document). In production, replace this with an upload to
  // your storage and return the resulting URL instead.
